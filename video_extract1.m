function [video_mat,color_burst_mat]=video_extract1(raw_video, sync_threshold)
    ...
    line_number=0;
    field_number=1;
    hsync_low2active_video=round(9.2*(10^(-6))/sample_time); %active video is 9.2us from falling edge of HSYNC
